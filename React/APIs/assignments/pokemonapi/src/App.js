...
function App() {
  ...
  //   console.log(pokemon)
  // }
  //above is the failure attempt to gather both name and img at the same async function
  ...
  //   searchPokemon()
  // },[pokemons])
  //when i use the useEffect hook, console logs errors saying fail to fetch, but when using it as a function inside the return statement, there is no fetch fail.
  return (
    <div className="App">
      <div>
